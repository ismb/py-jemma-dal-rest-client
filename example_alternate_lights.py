...
def run_program():
	...
	while (True):
		...
		mydal.request_property_write(L[1],"ColorControl","HS",'[{"type":"java.lang.Short","value":"'+str(COLORS[0][0])+'"},{"type":"java.lang.Short","value":"'+str(COLORS[0][1])+'"}]');
		mydal.request_property_write(L[2],"ColorControl","HS",'[{"type":"java.lang.Short","value":"'+str(COLORS[0][0])+'"},{"type":"java.lang.Short","value":"'+str(COLORS[0][1])+'"}]');
		mydal.request_property_write(L[3],"ColorControl","HS",'[{"type":"java.lang.Short","value":"'+str(COLORS[0][0])+'"},{"type":"java.lang.Short","value":"'+str(COLORS[0][1])+'"}]');
		mydal.request_property_write(L[4],"ColorControl","HS",'[{"type":"java.lang.Short","value":"'+str(COLORS[0][0])+'"},{"type":"java.lang.Short","value":"'+str(COLORS[0][1])+'"}]');
		mydal.request_property_write(L[5],"ColorControl","HS",'[{"type":"java.lang.Short","value":"'+str(COLORS[0][0])+'"},{"type":"java.lang.Short","value":"'+str(COLORS[0][1])+'"}]');
		sleep(SLEEPTIME);
		i+=1;
