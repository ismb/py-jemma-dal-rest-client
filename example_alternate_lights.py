...
def run_program():
	...
	while (True):
		...
		DALClient.request_property_write(DAL_ADDR,L[1],"ColorControl","HS",'[{"type":"java.lang.Short","value":"'+str(COLORS[0][0])+'"},{"type":"java.lang.Short","value":"'+str(COLORS[0][1])+'"}]');
		DALClient.request_property_write(DAL_ADDR,L[2],"ColorControl","HS",'[{"type":"java.lang.Short","value":"'+str(COLORS[0][0])+'"},{"type":"java.lang.Short","value":"'+str(COLORS[0][1])+'"}]');
		DALClient.request_property_write(DAL_ADDR,L[3],"ColorControl","HS",'[{"type":"java.lang.Short","value":"'+str(COLORS[0][0])+'"},{"type":"java.lang.Short","value":"'+str(COLORS[0][1])+'"}]');
		DALClient.request_property_write(DAL_ADDR,L[4],"ColorControl","HS",'[{"type":"java.lang.Short","value":"'+str(COLORS[0][0])+'"},{"type":"java.lang.Short","value":"'+str(COLORS[0][1])+'"}]');
		DALClient.request_property_write(DAL_ADDR,L[5],"ColorControl","HS",'[{"type":"java.lang.Short","value":"'+str(COLORS[0][0])+'"},{"type":"java.lang.Short","value":"'+str(COLORS[0][1])+'"}]');
		sleep(SLEEPTIME);
		i+=1;
